...
class SearchRoom extends StatefulWidget {
  ...
  @override
  State<SearchRoom> createState() => _SearchRoomState(this.args);
}
...
class _SearchRoomState extends State<SearchRoom> {
  ...
  List tiles = [];
final args;
  _SearchRoomState(this.args);
  static String BASE_URL_CATEGORY = '' + Global.url + '/room-building';

  void getData() async {
    var c = 0;
    final response = await http.get(Uri.parse(BASE_URL_CATEGORY+'?building_name=${args[0]}&floor=${args[1]}'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Building - ${args[0]}, Floor - ${args[1]}",style:TextStyle(color: Color(0xffffff00))),
        ),
        body: ListView(
          children: [
            Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        //  args[2].toString()==(b['label']).toString() ? Text("*",style: TextStyle(color:Colors.red),) : Text(''),
